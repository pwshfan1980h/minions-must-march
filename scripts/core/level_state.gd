...
const LEVELS := {
	...
	7: {
		...
		"builders": 1,
		"diggers": 1,
		"spawn_position": Vector2(1190, 292),
		"spawn_direction": -1,
		"exit_position": Vector2(282, 420),
		"hint": "Ash Catacombs: march left, DIG the gutter plug, survive the drop, then spend one BLOCK/BUILD to finish the lower switchback.",
	},
	8: {
		"name": "Crumbling Rib Toll",
		"terrain": "level_008",
		"rescue_required": 8,
		"minions": 12,
		"spawn_interval": 0.78,
		"blockers": 1,
		"builders": 2,
		"spawn_position": Vector2(210, 420),
		"spawn_direction": 1,
		"exit_position": Vector2(1390, 324),
		"hint": "Race the crumble toll: hold the crowd, build twice up the ribs, and do not linger on the weak middle span.",
	},
	9: {
		"name": "Featherfall Reliquary",
		"biome": "ash_catacombs",
		"terrain": "level_009",
		"rescue_required": 9,
		"minions": 12,
		...
		"diggers": 1,
		"featherfalls": 1,
		"spawn_position": Vector2(232, 260),
		"spawn_direction": 1,
		"exit_position": Vector2(1265, 452),
		"hint": "A taller reliquary: DIG the safe shaft, use FEATHER only if the scout misses the ledge, then turn and bridge the final cut.",
	},
	10: {
		"name": "Gravebell Descent",
		"biome": "ash_catacombs",
		"terrain": "level_010",
		"rescue_required": 9,
		"minions": 12,
		...
		"builders": 1,
		"diggers": 1,
		"spawn_position": Vector2(220, 260),
		"spawn_direction": 1,
		"exit_position": Vector2(1320, 340),
		"hint": "Ring the lower route open with DIG, regroup on the landing, then BUILD up to the gravebell shelf.",
	},
	11: {
		...
		"builders": 1,
		"featherfalls": 1,
		"spawn_position": Vector2(760, 260),
		"spawn_direction": -1,
		"exit_position": Vector2(1380, 340),
		"hint": "Let the march drop left, BLOCK the lower cliff to reverse it, then BUILD toward the lantern. FEATHER can save the scout.",
	},
	12: {
		...
		"diggers": 1,
		"featherfalls": 1,
		"spawn_position": Vector2(200, 260),
		"spawn_direction": 1,
		"exit_position": Vector2(1580, 292),
		"hint": "Finale: DIG into the procession hall, then BUILD both rising Styx cuts. Keep one BLOCK and FEATHER for recovery.",
	},
}
